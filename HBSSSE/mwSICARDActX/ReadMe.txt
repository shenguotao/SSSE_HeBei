========================================================================
    ACTIVEX 控件 DLL : mwSICARDActX 项目概述
========================================================================

控件向导已为 mwSICARDActX ActiveX 控件 DLL 创建此项目，其中包含一个控件。

此主干项目不仅演示了编写 ActiveX 
控件的基本方法，而且还可以作为编写控件特定功能的起点。

本文件概要介绍组成 mwSICARDActX ActiveX 控件 DLL 的每个文件的内容。

mwSICARDActX.vcxproj
    这是使用应用程序向导生成的 VC++ 项目的主项目文件，
    其中包含生成该文件的 Visual C++ 
    的版本信息，以及有关使用应用程序向导选择的平台、
    配置和项目功能的信息。

mwSICARDActX.vcxproj.filters
...
/////////////////////////////////////////////////////////////////////////////
CmwSICARDActXCtrl 控件：

mwSICARDActXCtrl.h
    此文件包含 CmwSICARDActXCtrl C++ 类的声明。

mwSICARDActXCtrl.cpp
    此文件包含 CmwSICARDActXCtrl C++ 类的实现。

mwSICARDActXPropPage.h
    此文件包含 CmwSICARDActXPropPage C++ 类的声明。

mwSICARDActXPropPage.cpp
    此文件包含 CmwSICARDActXPropPage C++ 类的实现。

CmwSICARDActXCtrl.bmp
    此文件包含一个位图，当 CmwSICARDActXCtrl 
...
stdAfx.h，stdAfx.cpp
    这些文件用于生成名为 mwSICARDActX.pch 的预编译头 (PCH) 文件和名为 
